...
public class DESUtil {
	private static String strDefaultKey = "qh_cloud";

	public static int CIPHERTEXT_LENGTH = 80;
	...
	public static void main(String[] args) throws Exception {
		...
		DESUtil DESUtil = new DESUtil();
		String test = "如果你说，你说如果，爱能重新来过";
		System.out.println(test.length());
		String e = DESUtil.encrypt(test);
		System.out.println(e);
		System.out.println(e.length());
		String d = DESUtil.decrypt(e);
		System.out.println(d);
		// 使用新密钥
		DESUtil DESUtil2 = new DESUtil("lqh");
		String e2 = DESUtil2.encrypt("root");
		System.out.println(e2 + "--" + "root".length() + "--" + e2.length());
		String d2 = DESUtil2.decrypt(e2);
